# Skills dalam repo ini

Setiap subfolder adalah satu skill mandiri (biasanya berisi `SKILL.md`).
...
| [`solidjs-2/`](solidjs-2/) | SolidJS 2.0 (beta): async-first reactivity, split effects, stores, actions, JSX, and migrations |
...
Pasang per skill dari root repo: lihat [`../README.md`](../README.md).